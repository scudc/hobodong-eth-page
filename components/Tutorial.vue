  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="flex justify-center pt-8 sm:pt-0" href="#">
       <img class="hobo-logo" viewBox="0 0 45 30" fill="none" src="~/static/hobo-logo.png">
       </img>
       </a>
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          Programmer ,Blockchain Technology Enthusiast, Decentralized Practitioner<br>
        </p>
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          Please contact me by scudongchao@gmail.com. Have fun!
        </p>
      </div>
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/scudc" target="_blank"><svg
        ...
        <a href="https://twitter.com/hobo83582619" target="_blank"><svg
          class="w-6 h-6 text-gray-600 hover:text-gray-800"
          xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink"
          aria-hidden="true"
